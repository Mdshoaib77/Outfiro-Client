    ...
    return (
        <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[667px] w-full mb-10 relative overflow-hidden'>
            ...
            <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className='bg-white dark:bg-gray-800 p-3 rounded-2xl max-w-[233px] relative top-8 xl:top-12'
            >
                <div className='relative'>
                    <motion.img
                        src={heroImg}
                ...
                <motion.p
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.5, duration: 0.6 }}
                    className='text-[13px] dark:text-gray-200'
                >
                    <b className='uppercase'>Unlock</b> your best look, one click at a time, Your style upgrade starts here, shop today!
                </motion.p>
            </motion.div>
            ...
            >
                ...
                <motion.h1
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.6 }}
                    className='h1 font-[500] capitalize max-w-[722px] dark:text-white'
                >
                    Every click brings you closer to perfection shop now!
                </motion.h1>
                ...
                <motion.div
                    ...
                    className='flex'
                >
                    <Link className='pl-5 text-xs font-medium capitalize bg-white rounded-full dark:bg-gray-800 dark:text-white flexCenter gap-x-2 group'>
                        Check our modern Collection
                        <motion.div
                            whileHover={{ rotate: -20 }}
                            transition={{ type: "spring", stiffness: 200 }}
